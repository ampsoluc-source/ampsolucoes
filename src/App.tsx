export default function AMPLandingPage() {
  ...
  const services = [
    ...
    },
    {
      ...
      desc: 'Manutenção preventiva e corretiva de sistemas elétricos.',
    },
    {
      icon: '🏢',
      title: 'Soluções Completas',
      desc: 'Atendimento residencial, comercial e industrial.',
    },
    {
      icon: '📅',
      ...
      <footer className="bg-black border-t border-[#1a9caa]/20 py-16 px-6">
        <div className="max-w-7xl mx-auto grid md:grid-cols-4 gap-12 mb-12">
          <div>
            ...
            <p className="text-gray-400 text-sm">Serviços elétricos com qualidade, responsabilidade e segurança para sua casa.</p>
          </div>
